 ...
 */
public class IncisionPicture04 {/*
    ...
    *//**
    ...
    public boolean incisionIcon(String iconPath, String saveIconPath) {
        ...
        picture = new Picture(iconPath, saveIconPath, bufferedImage);
        ...
        System.out.println(max_value + "\t" + top_y);
        // 截取图片  top_y 顶部位置 ，x 从 top_y 开始切割，所以应该去除
        return picture.cutPicture(PictureNumber.PICTURE_COUNT, top_y, bufferedImage.getHeight() - 40,
    ...
    *//**
    ...
    public boolean incisionPicture(String picturePath, String saveFolderPath) {
        ...
        int minX;
        System.out.println(min_X[0] + "\t" + min_X[1] + "\t" + centreX);
